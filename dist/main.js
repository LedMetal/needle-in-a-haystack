...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BlockOne; });
...
class BlockOne {
  ...
  evaluatePage() {
    ...
    this.score[`page${this.currentPage}`].timestamps.end = new Date(); // Set time spent on current page

    this.score[`page${this.currentPage}`].timeOnPage = this.setTimeOnPage(); // Set array of selected icons

    this.score[`page${this.currentPage}`].selectedIcons = this.getSelectedIcons(); // Set total icons selected

    this.score[`page${this.currentPage}`].totalSelected = this.score[`page${this.currentPage}`].selectedIcons.length; // Categorize the selected icons (increment appropriate icon types)
  ...
  savePage() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post('./b1_SavePage.php', {
  ...
  endEvaluation() {
    ...
    this.score.totalPages = this.currentPage; // Set total icons viewed (40 per page * total pages viewed)

    this.score.totalIconsViewed = 40 * this.score.totalPages; // Set time per page (concatinated string)

    this.score.timePerPage = this.setTimePerArray(); // Set average time per page (total time / total pages)

    this.score.averageTimePerPage = this.getAverageTimePerArray(); // Set total number of target icons viewed (8 * total pages viewed)

    this.score.totalTargetsViewed = 8 * this.score.totalPages; // Set total number of correct selections (target icons)

    this.score.totalTargetsSelected = this.getTotalTargetsSelected(); // Set ratio of correctly selected target icons to total target icons

    this.score.targetsSelectedRatio = this.getTargetsSelectedRatio(); // Set total number of incorrect selections (non-target icons)
  ...
  saveBlock() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post('./b1_SaveBlock.php', {
      participantID: this.participantID,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BlockOneExample; });
class BlockOneExample {
  constructor() {
    this.targetIcon = '🎪';
    this.nonTargetIcons = ['💀', '👻', '🙉', '💘', '💥', '💣', '🖖', '💂', '💻', '💑', '👣', '🐎', '🌻', '🌎', '🗽'];
    this.grid = [];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BlockTwo; });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
...
class BlockTwo {
      ...
      for (let i = 0; i < this.iconCount.partnerIcon; i++) {
        ...
        */
        ...
        do {
          ...
          randomIndex = Math.floor(Math.random() * (this.grid.length - 1)) + 1; // Grab icon in grid at random index

          randomIcon = this.grid[randomIndex]; // Verify the random icon is one of our 12 target icons
  ...
  getSelectedIcons() {
    ...
    for (let i = 0; i < selectedElements.length; i++) {
      selectedIcons.push({
        icon: selectedElements[i].innerHTML,
        partnered: selectedElements[i].classList.contains('partnered')
      });
    }
  ...
  savePage() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post('./b2_SavePage.php', {
      participantID: this.participantID,
      page: this.currentPage,
      duration: this.score[`page${this.currentPage}`].timeOnPage,
      totalSelected: this.score[`page${this.currentPage}`].totalSelected,
  ...
  endEvaluation() {
    ...
    this.score.totalTargetsSelected = this.getTotalTargetsSelected(); // Set total number of un-partnered targets selected

    this.score.totalUnpartneredTargetsSelected = this.getTotalUnpartneredTargetsSelected(); // Set ratio of correctly selected target icons to total target icons
  ...
  saveBlock() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post('./b2_SaveBlock.php', {
      participantID: this.participantID,
      evaluationDate: this.evaluationDate,
      evaluationTime: this.evaluationTime,
      totalPages: this.score.totalPages,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BlockTwoExample; });
class BlockTwoExample {
  constructor() {
    this.targetIcon = '🎪';
    this.partnerIcon = '🎀';
    this.nonTargetIcons = ['💀', '👻', '🙉', '💘', '💥', '💣', '🖖', '💂', '💻', '💑', '👣', '🐎', '🌻', '🌎', '🗽'];
  ...
  chooseIcons() {
    this.grid = []; // Push the target icons into grid array
...
/* harmony import */ var _BlockOne__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./BlockOne */ "./src/BlockOne.js");
/* harmony import */ var _BlockOneExample__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./BlockOneExample */ "./src/BlockOneExample.js");
/* harmony import */ var _BlockTwo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./BlockTwo */ "./src/BlockTwo.js");
/* harmony import */ var _BlockTwoExample__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BlockTwoExample */ "./src/BlockTwoExample.js");
...
const blockOne = new _BlockOne__WEBPACK_IMPORTED_MODULE_2__["default"]();
const blockOneExample = new _BlockOneExample__WEBPACK_IMPORTED_MODULE_3__["default"]();
const blockTwo = new _BlockTwo__WEBPACK_IMPORTED_MODULE_4__["default"](blockOne.participantID, blockOne.evaluationDate);
const blockTwoExample = new _BlockTwoExample__WEBPACK_IMPORTED_MODULE_5__["default"]();
let currentBlock = 1;
/* -------------------- EVENT LISTENERS -------------------- */
...
_domElements__WEBPACK_IMPORTED_MODULE_0__["btnExample"].addEventListener("click", () => {
  goToTestPhase();

  if (currentBlock === 1) {
    // Hide the additional header info on test page
    _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["additionalHeader"]);
    _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["partnerIcon"]);
    console.log("showing pre message");
    _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["preButtonMessage"]);
    blockOneExample.beginExample();
  } else if (currentBlock === 2) {
    // Display the additional header info on test page
    _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["additionalHeader"]);
    _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["partnerIcon"]); // Display the example-done button and hide the next page button

    _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["btnExampleDone"]);
    _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["btnNextPage"]);
    console.log("showing pre message");
    _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["preButtonMessage"]);
...
_domElements__WEBPACK_IMPORTED_MODULE_0__["btnStart"].addEventListener("click", () => {
  goToTestPhase();
  console.log("hiding pre message");
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["preButtonMessage"]);
...
_domElements__WEBPACK_IMPORTED_MODULE_0__["btnExampleDone"].addEventListener("click", () => {
  goToIntroPhase();
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["btnExample"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["btnStart"]);
  _domElements__WEBPACK_IMPORTED_MODULE_0__["introHeader"].innerText = "Great Work!";

  if (currentBlock === 1) {
    _domElements__WEBPACK_IMPORTED_MODULE_0__["introInstructions"].innerHTML = `
...
_domElements__WEBPACK_IMPORTED_MODULE_0__["btnNextPage"].addEventListener("click", () => {
  if (currentBlock === 1) {
    blockOne.evaluatePage(); // blockOne.savePage()

    blockOne.init();
    blockOne.beginEvaluation();
  } else if (currentBlock === 2) {
    blockTwo.evaluatePage(); // blockTwo.savePage()
...
_domElements__WEBPACK_IMPORTED_MODULE_0__["btnBlockTwo"].addEventListener("click", () => {
  currentBlock++;
  goToIntroPhase();
  _domElements__WEBPACK_IMPORTED_MODULE_0__["introHeader"].innerText = "Needle in a Haystack";
  _domElements__WEBPACK_IMPORTED_MODULE_0__["introInstructions"].innerHTML = `
  ...
  `;
  _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["btnExample"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["btnStart"]);
});
/* --------------------------------------------------------- */

const goToIntroPhase = () => {
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["testPhase"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["resultPhase"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["introPhase"]);
};

const goToTestPhase = () => {
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["introPhase"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["resultPhase"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["testPhase"]);
};

const goToResultsPhase = () => {
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["introPhase"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["testPhase"]);
  _functions__WEBPACK_IMPORTED_MODULE_1__["showDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["resultPhase"]);

  if (currentBlock === 1) {
    _domElements__WEBPACK_IMPORTED_MODULE_0__["resultsJumbotron"].innerHTML = blockOne.resultsHTML;
  } else {
    _domElements__WEBPACK_IMPORTED_MODULE_0__["resultsJumbotron"].innerHTML = blockTwo.resultsHTML;
    _functions__WEBPACK_IMPORTED_MODULE_1__["hideDiv"](_domElements__WEBPACK_IMPORTED_MODULE_0__["btnBlockTwo"]);
  }
};
...
const setTimer = () => {
  setTimeout(() => {
    if (currentBlock === 1) {
      ...
      blockOne.endEvaluation(); // blockOne.saveBlock()

      blockOne.prepareResultsHTML();
    } else if (currentBlock === 2) {
      blockTwo.evaluatePage(); // blockTwo.savePage()

      blockTwo.endEvaluation(); // blockTwo.saveBlock()
...
/*!****************************!*\
  !*** ./src/domElements.js ***!
  \****************************/
/*! exports provided: introPhase, introHeader, introInstructions, btnExample, btnStart, testPhase, additionalHeader, partnerIcon, preButtonMessage, btnExampleDone, btnNextPage, resultPhase, resultsJumbotron, btnBlockTwo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "introPhase", function() { return introPhase; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "introHeader", function() { return introHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "introInstructions", function() { return introInstructions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnExample", function() { return btnExample; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnStart", function() { return btnStart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testPhase", function() { return testPhase; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "additionalHeader", function() { return additionalHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "partnerIcon", function() { return partnerIcon; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "preButtonMessage", function() { return preButtonMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnExampleDone", function() { return btnExampleDone; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnNextPage", function() { return btnNextPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resultPhase", function() { return resultPhase; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resultsJumbotron", function() { return resultsJumbotron; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnBlockTwo", function() { return btnBlockTwo; });
...
const additionalHeader = document.querySelector('.test-phase .additional-header');
const partnerIcon = document.querySelector('.test-phase .partner-icon');
const preButtonMessage = document.querySelector('.pre-button-message-container');
const btnExampleDone = document.querySelector('.btn-example-done');
const btnNextPage = document.querySelector('.btn-next');
const resultPhase = document.querySelector('.result-phase');
const resultsJumbotron = document.querySelector('.result-phase .jumbotron .results');
const btnBlockTwo = document.querySelector('.btn-block-two');
...
/*!**************************!*\
  !*** ./src/functions.js ***!
  \**************************/
/*! exports provided: hideDiv, showDiv */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hideDiv", function() { return hideDiv; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showDiv", function() { return showDiv; });
