...
class BlockOne {
  ...
  savePage() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post('./savePage.php', {
  ...
  saveBlock() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post('./saveBlock.php', {
      participantID: this.participantID,
...
_domElements__WEBPACK_IMPORTED_MODULE_0__["btnNextPage"].addEventListener('click', () => {
  ...
  blockOne.savePage();
  blockOne.init();
  blockOne.beginEvaluation(); // Reset onCLick Handlers for icons
...
/*!****************************!*\
  !*** ./src/domElements.js ***!
  \****************************/
/*! exports provided: introPhase, introHeader, introInstructions, btnExample, btnStart, testPhase, additionalHeader, partnerIcon, btnExampleDone, btnNextPage, resultPhase, resultsJumbotron, btnBlockTwo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
