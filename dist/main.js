...
class BlockTwoExample {
  ...
  chooseIcons() {
    ...
    /* LET'S TRY TO DO THIS IN THE shuffleGrid() FUNCTION INSTEAD */
    // for (let i = 0; i < this.iconCount.partner; i++) {
    //   this.grid.push(this.partnerIcon);
    // }
...
console.log('Block One Example: ', blockOneExample);
...
/*!****************************!*\
  !*** ./src/domElements.js ***!
  \****************************/
/*! exports provided: introPhase, introHeader, introInstructions, btnExample, btnStart, testPhase, btnExampleDone, btnNextPage, resultPhase, resultsJumbotron, btnBlockTwo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
