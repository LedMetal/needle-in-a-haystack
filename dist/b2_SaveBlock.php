<?php
  ...
  $totalUnpartneredTargetsSelected = $_POST["totalUnpartneredTargetsSelected"];
  $targetsSelectedRatio = $_POST["targetsSelectedRatio"];
  $totalNonTargetsSelected = $_POST["totalNonTargetsSelected"];

  // SQL query
  $query = "INSERT INTO block_two (participant_id, evaluation_date, evaluation_time, total_pages, icons_viewed, time_per_page, avg_time_page, total_targets, identified_partnered_targets, identified_unpartnered_targets, targets_ratio, identified_non_targets) VALUES ('$participantID', '$evaluationDate', '$evaluationTime', $totalPages, $totalIconsViewed, '$timePerPage', $averageTimePerPage, $totalTargetsViewed, $totalTargetsSelected, $totalUnpartneredTargetsSelected, $targetsSelectedRatio, $totalNonTargetsSelected)";
